...
const { setFontSizeController, showSideBarExecute, font_size_options, language_i18n_options } =
  useComponentStore();
  ...
  <div class="header" :style="`background-image: url(${topbar_bg})`">
    ...
    <div class="xl-tools-box is-xl">
      ...
      <el-tooltip
        class="box-item"
        effect="light"
        :content="font_size_options.find(el => el.val === fontSizeController).opt"
        placement="bottom"
      >
        <div class="icon">
          <el-dropdown
...
.header {
  @apply w-full h-16 bg-header-img bg-no-repeat bg-left flex justify-end items-center p-5 bg-cover;
  .burger {
